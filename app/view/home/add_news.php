                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-10">
                        <div class="login-content bg-white p-30 box-shadow">
                            ...
                            <form  method="post" enctype="multipart/form-data" action="../../controller/newsController.php">
                                <div class="form-group">
                                    <input type="tel" name="title" class="form-control" id="exampleInputEmail1" placeholder="Post Title">
                                </div>
                                <div class="form-group">
                                    <textarea name="content" class="form-control" cols="123"  rows="7" placeholder="Post Content"></textarea>
                                </div>
                                ...
                                <button type="submit" name="add_news" class="btn mag-btn mt-30">Post</button>
                            </form>
