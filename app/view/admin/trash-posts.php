...
$query=mysqli_query($con,"update news set Is_Active=1 where news_id='$postid'");
if($query)
{
...
<?php
$query=mysqli_query($con,"select *,news.news_id as postid,news.title as title from news where news.Is_Active=0");
