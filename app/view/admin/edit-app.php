...
//        ######
    ...
    if(addFile()!= null){
        $app_file = addFile();
            ...
            $app_file = $_POST['last_app_file'];
        }
        
        if(addImage()!= null){
        $img = addImage();
    }elseif (addImage()== null) {
            $img = $_POST['last_app_image'];
        }
        ...
        $query = mysqli_query($con, "update apps set app_name='$posttitle',price='$price',description='$postdetails',app_image='$img',app_file='$app_file',size='$app_size',version='$version',Is_Active='$status' where ID='$postid'");
        if ($query) {
            $msg = "Post updated ";
        } else {
                ...
                <div class="content-page">
                    ...
                    <div class="content">
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="page-title-box">
                                        <h4 class="page-title">Edit Apps </h4>
                            ...
                            <?php
                            $postid = intval($_GET['pid']);
                            $query = mysqli_query($con, "select *,apps.ID as postid,apps.app_image,apps.app_name as title,apps.description from apps where apps.ID='$postid' and apps.Is_Active=1 ");
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="card-box">
                                                                ...
                                                                <input type="number" name="price" class="form-control" id="exampleInputEmail1" value="<?php echo htmlentities($row['price']); ?>" placeholder="APK price" required>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="card-box">
                                                                ...
                                                                <input type="number" name="version" class="form-control" id="exampleInputEmail1" value="<?php echo htmlentities($row['version']); ?>" placeholder="APK version" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                     ...
                                                     <div class="row">
                                                        <div class="col-sm-12">
                                                            ...
                                                            <input type='hidden' name='last_app_file' value="<?php echo htmlentities($row['app_file']); ?>" >
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <div class="card-box">
                                                                ...
                                                                <img src="../home/images/apps/<?php echo htmlentities($row['app_image']); ?>" width="300"/>
                                                                <br />
                                                               <input type="file" class="form-control" id="postimage" name="postimage">
                                                                <input type='hidden' name='last_app_image' value="<?php echo htmlentities($row['app_image']); ?>" >
