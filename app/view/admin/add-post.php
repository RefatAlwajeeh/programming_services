...
if(isset($_POST['submit']))
{
        ...
        $path = "../home/images/news/" . time() . "." . end(explode(".", $_FILES['postimage']['name']));
...
$query=mysqli_query($con,"insert into news values('null','$posttitle','$postdetails','null','$img','$date','$Uid','$status')");
if($query)
{
