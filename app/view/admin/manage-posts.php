...
$query=mysqli_query($con,"update news set Is_Active=0 where news_id='$postid'");
if($query)
{
$msg="Post deleted ";
}
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
									...
									<br> <h4 class="page-title"> إدارة </h4>
...
<?php
$query=mysqli_query($con,"select news.news_id as postid,news.title as title,content from news where news.Is_Active=1 ");
